...
if __name__=='__main__':
    net=Network('Custom orbits · explicit mean anomalies',epoch='2025-06-02T12:00:00Z')
    for i,phase in enumerate([0,25,50]):
        net.add_satellite(f'Test-{i+1}',altitude_km=1000,inclination_deg=60,raan_deg=20,phase_deg=phase)
