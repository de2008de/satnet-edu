...
def make_network():
    ...
    net.add_constellation(planes=2,sats_per_plane=12,altitude_km=1000,inclination_deg=53)
    snapshot=net.at(0)
...
if __name__=='__main__':
    run=make_network().run(duration_s=300,step_s=5,record_routes=[RouteQuery('A-B-delay','A','B'),RouteQuery('A-B-hops','A','B','hops'),RouteQuery('A-Polar','A','Polar')])
